...
<div id="layout" align="center">
	<div id="middle">
		<c:if test="${authenticatedUser !=null}">
			<b>Enter User Identifications</b>
			<form action="CreateUserServlet?page=createuser" method="post">
				<table>
					...
					<tr>
						<td align="right"><b>User Full Name</b>
						</td>
						<td align="left"><input type="text" size="10" maxlength="50"
							name="userfullname" id="userfullname" />
						</td>
					</tr>
					<tr>
						<td align="right"><b>Role</b>
						</td>
						...
						<table>
							<tr bgcolor="gray">
								...
								<td align="left"><input type="text" size="10"
									maxlength="50" name="username" id="username" />
								</td>
							</tr>
							<tr bgcolor="gray">
								<td align="right"><b>Password</b>
