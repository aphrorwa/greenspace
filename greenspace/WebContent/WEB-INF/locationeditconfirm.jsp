...
<div id="layout" align="center">
	<c:if test="${authenticatedUser !=null}">
		<div id="middle">
			<div class="options">
				<a href="ListLocationServlet?page=createlocation">Create New
					Location</a>
			</div>
			<div class="search">
				<form action="ListLocationServlet" method="get">
					<table>
						<tr>
							<td style="color: #004216;">Enter Location Code</td>
							<td><input type="text" name="locationcode"
								id="locationcode" /></td>
		...
		<hr />
		<div id="middle">
			<h1>Location Successfully Updated</h1>
