...
<div id="layout" align="center">
	<c:if test="${authenticatedUser !=null}">
		<div id="middle">
			<div class="options">
				<a href="ListTreePlantedServlet?page=createtreeplanted">Create New
					Tree Planted</a>
			</div>
			<div class="search">
				<form action="ListTreePlantedServlet" method="get">
					<table>
						<tr>
							<td style="color: #004216;">Enter Tree Planted Id</td>
							<td><input type="text" name="treeplantedid"
								id="treeplantedid" /></td>
		...
		<hr />
		<div id="middle">
			<h1>Tree Planted Successfully Updated</h1>
